<h2><a href="https://www.geeksforgeeks.org/problems/print-gfg-n-times/1?page=1&category=Recursion&difficulty=Basic,Easy&status=solved,unsolved&sortBy=submissions">Print GFG n times</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Print GFG n times without the loop.</span></p>
