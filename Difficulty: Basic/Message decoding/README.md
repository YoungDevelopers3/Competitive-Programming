<h2><a href="https://www.geeksforgeeks.org/problems/message-decoding4305/1?page=1&category=two-pointer-algorithm&difficulty=Basic,Easy,Medium&sortBy=difficulty">Message decoding</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string S, check whether it can be converted into the string "hello" by deleting some characters from it.<br>
